...
iptables -I OUTPUT -m set --match-set block-australia src -j DROP && iptables -I OUTPUT -m set --match-set block-china src -j DROP && iptables -I OUTPUT -m set --match-set block-canada src -j DROP  
