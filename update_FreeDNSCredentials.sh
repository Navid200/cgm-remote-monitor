...
This utility allows you to enter your FreeDNS user ID and password in Google Cloud Nightscout.\n\
It does not change your FreeDNS user ID or password.  To do that, you will need to use a browser and log into FreeDNS. Then, use this utility to update Google Cloud Nightscout accordingly.\n\n\
