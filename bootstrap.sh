...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/API_Scrt_Exclude/bootstrap.sh | bash
...
sudo git checkout API_Scrt_Exclude  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
