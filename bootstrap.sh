...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MoreMenu_TestMirror/bootstrap.sh | bash
...
sudo git checkout MoreMenu_TestMirror  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
