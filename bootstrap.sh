...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Navid_08_05/bootstrap.sh | bash
...
sudo git checkout Navid_08_05  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
