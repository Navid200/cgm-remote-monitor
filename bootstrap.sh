...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/IdempotentUpdates_Test/bootstrap.sh | bash
...
sudo git checkout IdempotentUpdates_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
