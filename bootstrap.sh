...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/KeepPhase1Logs_Test/bootstrap.sh | bash
...
sudo git checkout KeepPhase1Logs_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
