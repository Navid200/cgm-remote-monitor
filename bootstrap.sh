...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NodeUpdate/bootstrap.sh | bash
...
sudo git checkout NodeUpdate  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
