...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Navid_2025_08_04/bootstrap.sh | bash
...
sudo git checkout Navid_2025_08_04  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
