...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Phase1Required_Test/bootstrap.sh | bash
...
sudo git checkout Phase1Required_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
