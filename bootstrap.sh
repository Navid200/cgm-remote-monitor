...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/LogsFunction_Test/bootstrap.sh | bash
...
sudo git checkout ChartBoundaries_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
