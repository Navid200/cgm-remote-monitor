...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/OnlyInstallNode16_Test/bootstrap.sh | bash
...
sudo git checkout OnlyInstallNode16_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
