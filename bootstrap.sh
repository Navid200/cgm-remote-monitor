...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Mongo7_Test/bootstrap.sh | bash
...
sudo git checkout Mongo7_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
