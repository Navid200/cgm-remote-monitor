...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MinimalDetectFix_Mirror/bootstrap.sh | bash
...
sudo git checkout MinimalDetectFix_Mirror  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
