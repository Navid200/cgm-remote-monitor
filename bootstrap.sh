...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/N15_0_6_PR_Test/bootstrap.sh | bash
...
sudo git checkout N15_0_6_PR_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
