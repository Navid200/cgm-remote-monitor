...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MoreMenuIncremental/bootstrap.sh | bash
...
#sudo git checkout MoreMenuIncremental  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
