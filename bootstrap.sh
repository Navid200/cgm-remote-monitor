...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Test_Dec2/bootstrap.sh | bash
...
sudo git checkout Test_Dec2  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
