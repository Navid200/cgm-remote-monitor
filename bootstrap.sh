...
If you already have an installtion on this machine and proceed by pressing enter, you will be modifying it.  If that's not your intention, please press escape to abort." 15 50
if [ $? -eq 255 ]
then
clear
exit
