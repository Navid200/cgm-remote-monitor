...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MissingNodeModuleStatusPage_Test/bootstrap.sh | bash
...
sudo git checkout MissingNodeModuleStatusPage_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
