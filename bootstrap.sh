...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NS_Dev_Mar252026/bootstrap.sh | bash
...
sudo git checkout NS_Dev_Mar252026  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
