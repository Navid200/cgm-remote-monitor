...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/ub24_Test/bootstrap.sh | bash
...
sudo git checkout ub24_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
