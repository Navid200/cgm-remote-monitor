...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/N15_0_6_Test/bootstrap.sh | bash
...
sudo git checkout N15_0_6_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
