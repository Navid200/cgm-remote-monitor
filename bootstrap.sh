...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MongoSetupFixPR_Verify/bootstrap.sh | bash
...
sudo git checkout MongoSetupFixPR_Verify  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
