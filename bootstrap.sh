...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/BlockChina_Test/bootstrap.sh | bash
...
sudo git checkout BlockChina_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
