...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NS15_Node16_Test/bootstrap.sh | bash
...
sudo git checkout NS15_Node16_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
