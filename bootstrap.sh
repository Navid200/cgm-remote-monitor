...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/ub24_Test4/bootstrap.sh | bash
...
sudo git checkout ub24_Test4  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
