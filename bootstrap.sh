...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/ub24_Test2_Test/bootstrap.sh | bash
...
sudo git checkout ub24_Test2_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
