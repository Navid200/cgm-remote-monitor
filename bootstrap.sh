...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NS15_0_6_Incremental_Test/bootstrap.sh | bash
...
sudo git checkout NS15_0_6_Incremental_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
