...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NS_15_Test/bootstrap.sh | bash
...
sudo git checkout NS_15_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
