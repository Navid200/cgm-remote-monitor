...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/15_0_7_Test/bootstrap.sh | bash
...
sudo git checkout 15_0_7_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
