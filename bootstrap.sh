...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MinimalDetectFix/bootstrap.sh | bash
...
if [[ ! "$ubversion" = "20.04"* ]]  # If the selected version of ubuntu is not exactly what we want
then
clear
dialog --colors --msgbox "       \Zr Developed by the xDrip team \Zn\n\n\
