...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NoNode14DeprecationWarning_Test/bootstrap.sh | bash
...
sudo git checkout NoNode14DeprecationWarning_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
