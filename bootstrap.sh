...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/IncrementalUpdate_Test/bootstrap.sh | bash
...
sudo git checkout IncrementalUpdate_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
