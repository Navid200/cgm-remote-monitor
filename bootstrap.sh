...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MongoUpdate_Test/bootstrap.sh | bash
...
sudo git checkout MongoUpdate_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
