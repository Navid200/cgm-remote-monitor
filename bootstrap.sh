...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Node18_Test/bootstrap.sh | bash
...
sudo git checkout Node18_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
