...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/FixLogs_Test/bootstrap.sh | bash
...
sudo git checkout FixLogs_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
