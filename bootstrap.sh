...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/VisiblePhase1Progress_Test/bootstrap.sh | bash
...
sudo git checkout VisiblePhase1Progress_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
