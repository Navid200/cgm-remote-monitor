...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Ubuntu24_04_4_Test/bootstrap.sh | bash
...
sudo git checkout Ubuntu24_04_4_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
