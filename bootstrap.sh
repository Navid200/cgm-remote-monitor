...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/FreeDNSDown_TestPrior/bootstrap.sh | bash
...
sudo git checkout FreeDNSDown_TestPrior  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
