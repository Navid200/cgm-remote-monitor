...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Ub20_WillNotBeUpdated_Test/bootstrap.sh | bash
...
sudo git checkout Ub20_WillNotBeUpdated_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
