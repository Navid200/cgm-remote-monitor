...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NoMenu_Test/bootstrap.sh | bash
...
sudo git checkout NoMenu_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
