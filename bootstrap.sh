...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/resolvectl_Test/bootstrap.sh | bash
...
sudo git checkout resolvectl_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
