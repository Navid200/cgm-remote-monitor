...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/MongoStartFix_Test/bootstrap.sh | bash
...
sudo git checkout MongoStartFix_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
