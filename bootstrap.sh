...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/NodeUpgradeOnseShot_Test/bootstrap.sh | bash
...
sudo git checkout NodeUpgradeOnseShot_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
