...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Phase1Troubleshoot/bootstrap.sh | bash
...
sudo git checkout Phase1Troubleshoot  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
