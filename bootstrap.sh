...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/Node22_Test/bootstrap.sh | bash
...
sudo git checkout Node22_Test  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
