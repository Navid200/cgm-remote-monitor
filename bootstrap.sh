...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/UpdateToNode16_Test2/bootstrap.sh | bash
...
sudo git checkout UpdateToNode16_Test2  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
