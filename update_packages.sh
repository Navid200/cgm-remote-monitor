...
if [ "$whichpack" = "" ]
then
  sudo apt-get install -y screen nano qrencode file inetutils-ping nginx python3-certbot-nginx inetutils-ping ca-certificates apt-transport-https lsb-release gnupg
fi
