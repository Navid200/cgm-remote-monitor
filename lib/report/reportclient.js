...
var init = function init () {
  ...
  client.init(function loaded () {
    ...
    function prepareGUI () {
      ...
      $('#rp_agp_ymin').val(agpYAxisDefault[client.settings.units.toLowerCase()].agp_ymin);
      $('#rp_agp_ymax').val(agpYAxisDefault[client.settings.units.toLowerCase()].agp_ymin);
    ...
    function show (event) {
      ...
      options.agp_ymin = parseFloat($('#rp_agp_ymin').val().replace(',', '.'));
      options.agp_ymax = parseFloat($('#rp_agp_ymax').val().replace(',', '.'));
