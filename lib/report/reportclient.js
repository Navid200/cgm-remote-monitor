...
var init = function init () {
  ...
  client.init(function loaded () {
    ...
    function prepareGUI () {
      ...
      $('#rp_agpYAxisBottom').val(agpYAxisDefault[client.settings.units.toLowerCase()].agpbottom);
      $('#rp_agpYAxisTop').val(agpYAxisDefault[client.settings.units.toLowerCase()].agptop);
