...
function init () {
  ...
  var valueMappers = {
    ...
    , agpYAxisTop: mapNumber
    , agpYAxisBottom: mapNumber
  ...
  function verifyThresholds () {
    ...
    if (thresholds.agpYAxisBottom > 80) {
      console.warn('AGP_Y_AXIS_BOTTOM(' + thresholds.agpYAxisBottom + ') was > 80 mg/dL');
      thresholds.agpYAxisBottom = 80;
      console.warn('agpYAxisBottom is now 80 mg/dL');
    }
    if (thresholds.agpYAxisBottom < 0) {
      console.warn('AGP_Y_AXIS_BOTTOM(' + thresholds.agpYAxisBottom + ') was < 0 mg/dL');
      thresholds.agpYAxisBottom = 0;
      console.warn('agpYAxisBottom is now 0 mg/dL');
    }
    if (thresholds.agpYAxisTop < 90) {
      console.warn('AGP_Y_AXIS_TOP(' + thresholds.agpYAxisTop + ') was > 90 mg/dL');
      thresholds.agpYAxisTop = 90;
      console.warn('agpYAxisTop is now 90 mg/dL');
    }
    if (thresholds.agpYAxisTop > 400) {
      console.warn('AGP_Y_AXIS_TOP(' + thresholds.agpYAxisTop + ') was > 400 mg/dL');
      thresholds.agpYAxisTop = 400;
      console.warn('agpYAxisTop is now 400 mg/dL');
    }
  }
