...
function init () {
  ...
  function enableAndDisableFeatures (accessor, nameType) {
    ...
    thresholds.agpYAxisTop = Number(thresholds.agpYAxisTop);
    thresholds.agpYAxisBottom = Number(thresholds.agpYAxisBottom);
  ...
  function verifyThresholds () {
    ...
    if (thresholds.agpYAxisBottom > 75) {
      thresholds.agpYAxisBottom = 75;
    }
    if (thresholds.agpYAxisBottom < 0) {
      thresholds.agpYAxisBottom = 0;
    }
    if (thresholds.agpYAxisTop < 95) {
      thresholds.agpYAxisTop = 95;
    }
