...
This is only to enter the user ID and password in Google Cloud Nightscout.  If you want to change your user ID or password, you will need to log into FreeDNS to do that.  Enter your ID and password to proceed.  Or press escape to cancel." 21 50 0 "User ID:" 1 1 "$user" 1 14 25 0 "Password:" 2 1 "$pass" 2 14 25 0 2>&1 1>&3)
  response=$?
